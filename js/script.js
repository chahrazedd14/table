...
Vue.component('charttable',{
  ...
  template:
    `
<div id="chart_table"  >
        <div class="top_titles" class="row pt-5">
            <div class="col-2 pl-0"> id </div>
    ...
    <div v-for="(val, index)al in proplabels" class="row table_cell">
        <div class="col-2 medium-1 column">
            <input type="text" v-model="val.id" disabled></input>
        </div>
        <div  class="col-2 medium-2 column single-cel">
            <input type="text" v-model="val.percentual" v-bind:disabled="disabled">
            </input>
        </div>
        <div class="col-2 medium-6 column single-cel">
        ...
        <div class="col-2 medium-1 column edit_panel">
